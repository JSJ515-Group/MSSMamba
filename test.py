...
from models.MSSMamba import MSSMamba
import configs.MSSMamba_configs as configs
...
if __name__ == "__main__":
    ...
    CONFIGS = {
        'mssmamba': configs.get_mssmamba_configs(),
    }

    args.is_pretrain = True

    model = MSSMamba(config=CONFIGS[args.model_name], img_size=args.img_size, n_classes=args.num_classes).cuda()
    msg = model.load_state_dict(torch.load(args.model_weight))
    print("MSSMamba Model: ", msg)
